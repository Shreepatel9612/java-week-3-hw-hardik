 ...
 * person. *In case both firstName and lastName fields are empty, Strings return an empty String.
...
public class Programme_14_Person {
    ...
    // Method to get the value of firstName
    public String getFirstName() {
        return firstName;
    }

    // Method to get the value of lastName
    ...
    // Method to set the value of firstName
    public void setFirstName(String firstName) {
        this.firstName = firstName;
    }

    // Method to set the value of lastName
    public void setLastName(String lastName) {
        this.lastName = lastName;
    }

    // Method to set the value of age, with validation
